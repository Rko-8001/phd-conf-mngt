...
function ConferenceDetailsIndia({ user, data, links }) {
    return (
        <>
                ...
                <div className="border-t border-gray-200">
                    <dl>
                        ...
                        <div className="bg-gray-50 px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            ...
                            <dd className="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0">{data?.numberOfDays}</dd>
                        </div>
                        ...
                        <div className="bg-white px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            ...
                            <dd className="mt-1 text-md text-gray-900 sm:col-span-2 sm:mt-0">
                                <ul className="divide-y divide-gray-200 rounded-md border border-gray-200">
                                    <li className="flex items-center justify-between py-1 pl-3 pr-4 ">
...
export default ConferenceDetailsIndia