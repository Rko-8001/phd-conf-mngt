...
function ResearchNav() {
    ...
    return (
        <>
            <aside class="flex flex-col w-64 h-screen px-5 py-5 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700">
                <div class="flex flex-col items-center mt-1 -mx-2">
                    <img class="object-cover w-12 h-12 mx-2 rounded-full" src={userPhoto} alt="avatar" />
                ...
                <div class="flex flex-col justify-between flex-1 mt-6">
                    <nav class="-mx-3 space-y-6 ">
                        ...
                        <div class="space-y-3 ">
                            <label class="px-3 text-xs text-gray-500 uppercase dark:text-gray-400">Others</label>
                            ...
                            <a class="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700" href="#">
                                ...
                                <span class="mx-2 text-sm font-medium">User Guide</span>
                            </a>
