...
import Accounts_details from './Research_details';
import GenerateCard from './GenerateCard';
import Bar from './Bar';
import Accounts_statistics from './Research_statistics';
      ...
      <Container>
        ...
        <Row>
          <Col xs={12} md={6}>
            ...
            <Card>
              <Card.Header style={{ "fontSize": "24px" }}> Research Section</Card.Header>
              <br/>
